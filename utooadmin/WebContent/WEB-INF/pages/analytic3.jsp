    ...
    <section id="contentSection">
    	<div class="headerContentCont">
    		<div class="mainHeader">
    			Analytics Report on Completed Trip
    		</div>
        ...
        <div class="mainContentCont">
        		...
        		<div style="width:48%;float:left;margin:1%;">
        			 <iframe src="https://charts.qlikcloud.com/56485d3fa8cbbcf8360939bb/chart.html" style="width:100%;height:500px;border:1px solid #ccc;"></iframe> 
        		</div>
        		<div style="width:48%;float:left;margin:1%;">
        			 <iframe src="https://charts.qlikcloud.com/56485d69a8cbbcf8360939bc/chart.html" style="width:100%;height:500px;border:1px solid #ccc;"></iframe> 
        		</div>
