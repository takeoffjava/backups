    ...
    <section id="contentSection">
    	<div class="headerContentCont">
    		<div class="mainHeader">
    			Report on Kilometers Driven By Each Drivers
    		</div>
        ...
        <div class="mainContentCont">
        		...
        		<div style="width:48%;float:left;margin:1%;">
        			 <iframe src="https://charts.qlikcloud.com/56485da2a8cbbcf8360939bd/chart.html" style="width:100%;height:500px;border:1px solid #ccc;"></iframe> 
        		</div>
        		<div style="width:48%;float:left;margin:1%;">
        			 <iframe src="https://charts.qlikcloud.com/56485dbfa8cbbcf8360939be/chart.html" style="width:100%;height:500px;border:1px solid #ccc;"></iframe> 
        		</div>
