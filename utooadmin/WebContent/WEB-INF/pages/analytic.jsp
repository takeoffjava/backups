    ...
    <section id="contentSection">
        ...
        <div class="mainContentCont">
        		...
        		<div style="width:48%;float:left;margin:1%;">
        			 <iframe src="https://charts.qlikcloud.com/564859f3a8cbbcf8360939b4/chart.html" style="width:100%;height:500px;border:1px solid #ccc;"></iframe> 
        		</div>
        		<div style="width:48%;float:left;margin:1%;">
        			 <iframe src="https://charts.qlikcloud.com/56485a58a8cbbcf8360939b5/chart.html" style="width:100%;height:500px;border:1px solid #ccc;"></iframe> 
        		</div>
        		<div style="width:48%;float:left;margin:1%;">
        			 <iframe src="https://charts.qlikcloud.com/56485aa0a8cbbcf8360939b6/chart.html" style="width:100%;height:500px;border:1px solid #ccc;"></iframe> 
        		</div>
        		<div style="width:48%;float:left;margin:1%;">
        			 <iframe src="https://charts.qlikcloud.com/56485af8a8cbbcf8360939b8/chart.html" style="width:100%;height:500px;border:1px solid #ccc;"></iframe> 
        		</div>
        		</div>
