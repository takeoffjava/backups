...
<body>
    ...
    <section id="mainSection">
        <div id="sideBar">
            ...
            <a class="sideIndivMenu active" href="tariff"><i class="icon_set icon_tariff"></i> <span>TARIFF</span></a>
    ...
    <section id="contentSection">
			...
			<table id="example" class="display" cellspacing="0" width="100%">
				<thead>
					<tr>
						<th>Min Km</th>
						<th>Base Charge</th>
						<th>Min Charge(per Km)</th>
						<th>Ride charges(per minute)</th>
						<th>Car Model</th>
						<th>Edit</th>
					</tr>
				</thead>				
       ...
       <div id="divActionView" class="clsPopUp">
           ...
           <h3 class="subHeadTitle">Tariff</h3>
               <div class="fullRow">
                   <div class="halfColumn">
                       ...
                       <input type="text" id="minkms" maxlength="6" />
                       </div>
                   </div>
                   <div class="halfColumn">
                       <div class="colTitle">
                       ...
                       <div class="colContent headerPanelElemStyle">
                         ...
                         <input type="text" id="mincharge" maxlength="10" />
                       </div>
                   </div>
               </div>
               <div class="fullRow">
                   <div class="halfColumn">
                       ...
                       <div class="colContent">
                          <input type="text" id="ridecharge" maxlength="10" />
                       </div>
                   </div>
                   <div class="halfColumn">
                       <div class="colTitle">
                       ...
                       <div class="colContent">
                           <select id="selVechileMode" disabled>
					</select>
                       </div>
                   </div>
               </div>
                       <div >
                          <input type="button" id="btnSave" value="Update Tariff" class="clsButtonSmall" style="float: right;" onclick="return updatetariff_save();" />
                       </div>
           </div>
       </div>
