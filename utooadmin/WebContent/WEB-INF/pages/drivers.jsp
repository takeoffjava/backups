...
<div id="sideBar">
            ...
            <a class="sideIndivMenu active" href="drivers"><i class="icon_set icon_driver"></i> <span>DRIVERS</span></a>
    ...
    <section id="contentSection">
    	<div class="headerContentCont">
    		...
    		<div style="float:right;">
    			<div class="divsColors">
    				<p class="titleText">Available Drivers</p>
    				<span id="availableDrivers" class="textBlock">-</span>
    			</div>
    			<div class="divsColors">
    						<p class="titleText">Occupied Drivers</p>
    						<span id="busyDrivers" class="textBlock">-</span>
    			</div>
    			<div class="divsColors">
    						<p class="titleText">Offline Drivers</p>
    						<span id="offlineDrivers" class="textBlock">-</span>
    			</div>
    		</div>
    	</div>
       ...
       <div id="divActionView" class="clsPopUp">
        ...
        <div id="deletepopupdriver" class="clsPopUp">
      <div class="formSection">
      	<h3 class="subHeadTitle">Delete Driver</h3>
      <p style="color:#838383;">Are you sure want to delete?</p>
      <div style="text-align:right;">
      	<input type="button" onclick="return deletedriver_YES();"  class="clsButtonSmall" value="Delete">
