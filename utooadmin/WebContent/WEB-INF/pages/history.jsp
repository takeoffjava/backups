    ...
    <section id="contentSection">
    	...
    	<div class="headerContentCont">
    		...
    		<div class="headerPanel">
    			...
    			<div class="headerPanelElemStyle">
    				<input type="text" id="todate" onchange="return getHistoryByDate();" class="clsTxtbox bookingTo" placeholder="TO" data-field="date" data-format="yyyy-MM-dd" data-view="Dropdown" data-startend="end" data-startendelem=".bookingFrom" readonly />
    			</div>
