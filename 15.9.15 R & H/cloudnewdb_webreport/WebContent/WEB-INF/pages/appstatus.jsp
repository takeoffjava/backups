	...
	<!-- start: Header -->
		...
		<div class="row-fluid">
				...
				<div class="nav-collapse sidebar-nav">
                   ...
                   <!--     <li><a href="http://www.nutansrplus.com/appstatus"><i class="icon-user"></i><span class="hidden-tablet"> Admin</span></a></li> -->	
						...
						<li ><a href="records"><i class="icon-folder-close-alt"></i><span class="hidden-tablet"> Records</span></a></li>	
						 <li class="active"><a href="#"><i class="icon-random"></i><span class="hidden-tablet"> Appstatus</span></a></li>
			...
			<ul class="breadcrumb">
				...
				<li><select id="branches" onchange="appstatus_datatable();"></select></li>
			</ul>
...
function appstatus_datatable(){
	var branch_index=document.getElementById("branches").value;
	document.getElementById("loader").style.visibility="visible";
	datatable_creationonchangeappstatus(branch_index);
	document.getElementById("loader").style.visibility="hidden";
