...
<body onload="noBack();" onpageshow="if(event.persisted) noBack();">
	...
	<!-- start: Header -->
		...
		<div class="row-fluid">
			...
			<div class="row-fluid">
			<div class="login">
			<span class="logintext">DayWise Request Count</span></div>
			<div id="daywisedata"  style="padding:70px;"></div>
			<div class="login">
			<span class="logintext">Most Requested Table </div>		
			<div id="mostusedtable" style="padding:70px;"></div>
			<div class="login">
			<span class="logintext">UnAttended Table</span></div>
			...
			<div class="login">
			<span class="logintext">Monthwise Request Count</span></div>
			<div id="monthwise"  style="padding:70px;"></div>
			<div class="login">
			<span class="logintext">All Table Response Count</span></div>
