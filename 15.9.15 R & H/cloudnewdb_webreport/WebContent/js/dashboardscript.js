...
function dashboardCallback(resultobject){
	...
	for(var i=0;i<resultobject.overallrequestData.length;i++){
		overallrequestservice[i]=resultobject.overallrequestData[i].service;
		overallrequestbill[i]=resultobject.overallrequestData[i].bill;
		overallrequestwater[i]=resultobject.overallrequestData[i].water;
		overallrequestgoodservice[i]=resultobject.overallrequestData[i].goodService;
		
		}
	if(remote_typeJS==="white"){
	overall_requestcount_white();
	}else{
		overall_requestcount_black();
	}
	if(PAGENO===2){
		if(typeof resultobject.topwaiterData[0]!="undefined"){			//|| typeof resultobject.topwaiterData!=="undefined"
	document.getElementById("topuser").innerHTML="<table class='repTable'><tbody><tr><td><span style='color:#888;'>Top user</span></td><td><span style='font-size:22px;color:#6A5ACD;'>"+resultobject.topwaiterData[0].topuser
	+"</span></td></tr><tr><td><span style='color:#888;'>Best response (optimum)</span></td><td><span style='font-size:22px;color:#6A5ACD;'>"+resultobject.topwaiterData[0].avgresponse+" minutes."
	+"</span></td></tr></tbody></table>";
	document.getElementById("pooruser").innerHTML="<table class='repTable'><tbody><tr><td><span style='color:#888;'>Last user</span></td><td><span style='font-size:22px;color:#6A5ACD;'>"+resultobject.lastwaiterData[0].topuser
	+"</span></td></tr><tr><td><span style='color:#888;'>Best response (optimum)</span></td><td><span style='font-size:22px;color:#6A5ACD;'>"+resultobject.lastwaiterData[0].avgresponse+" minutes."
	+"</span></td></tr></tbody></table>";
		
		if(resultobject.costlytableData[0]!=="undefined"){
	document.getElementById("toptable").innerHTML="<table class='repTable'><tbody><tr><td><span style='color:#888;'>Top table</span></td><td><span style='font-size:22px;color:#6A5ACD;'>"+resultobject.costlytableData[0].tablename
	...
	+"</span></td></tr></tbody></table>";
	document.getElementById("poortable").innerHTML="<table class='repTable'><tbody><tr><td><span style='color:#888;'>Last table</span></td><td><span style='font-size:22px;color:#6A5ACD;'>"+resultobject.lowusetableData[0].tablename
	...
	var overallstr="";
	if(remote_typeJS==="white"){
		overallstr="<tr><td>"+1+"</td><td>Service</td><td>"+resultobject.overallrequestData[0].service+"</td></tr>"+
		"<tr><td>"+2+"</td><td>Bill</td><td>"+resultobject.overallrequestData[0].bill+"</td></tr>"+
		"<tr><td>"+3+"</td><td>Drink</td><td>"+resultobject.overallrequestData[0].water+"</td></tr>"+
		"<tr><td>"+4+"</td><td>GoodService</td><td>"+resultobject.overallrequestData[0].goodService+"</td></tr>";
	}
	else{
		overallstr="<tr><td>"+1+"</td><td>Service</td><td>"+resultobject.overallrequestData[0].service+"</td></tr>"+
					"<tr><td>"+2+"</td><td>Bill</td><td>"+resultobject.overallrequestData[0].bill+"</td></tr>"+
	...
	daywise_like=new Array();
		...
		for(var i=0;i<resultobject.Daywiserequestdata.length;i++){
			...
			daywiserequestdata_like[i]=resultobject.Daywiserequestdata[i].goodService;
		...
		for(var i=0;i<daywisereqlength;i++){
			...
			daywiserequest=daywiserequest+"<tr><td>"+(i+1)+"</td><td>"+myDateRequest+"</td><td>"+resultobject.Daywiserequestdata[i].service+"</td>" +
					"<td>"+resultobject.Daywiserequestdata[i].water+"</td><td>"+resultobject.Daywiserequestdata[i].bill+"</td></tr>";
			myDateRequest="";
		}
	...
	for(var i=0;i<resultobject.billaverageData.length;i++){
		billavg_tableno[i]=resultobject.billaverageData[i].tableno;
		billavg_count[i]=resultobject.billaverageData[i].avgbillresponse;
		}
	var billaveragestr="";
	...
	if(resultobject.billaverageData.length>5)
		billaveragelength=6;
	else
		billaveragelength=resultobject.billaverageData.length;
	...
	for(var i=0;i<resultobject.drinkaverageData.length;i++){
		drinkavg_tableno[i]=resultobject.drinkaverageData[i].tableno;
		drinkavg_count[i]=resultobject.drinkaverageData[i].avgdrinkresponse;
		}
	var drinkaveragestr="";
	...
	if(resultobject.drinkaverageData.length>5)
		drinkaveragelength=6;
	else
		drinkaveragelength=resultobject.billaverageData.length;
	...
	for(var i=0;i<resultobject.serviceaverageData.length;i++){
		serviceavg_tableno[i]=resultobject.serviceaverageData[i].tableno;
		serviceavg_count[i]=resultobject.serviceaverageData[i].avgserviceresponse;
		}
	...
	if(resultobject.serviceaverageData.length>5)
		serviceaveragelength=6;
	else
		serviceaveragelength=resultobject.serviceaverageData.length;
