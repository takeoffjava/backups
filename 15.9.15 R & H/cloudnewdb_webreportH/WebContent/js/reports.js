...
function dashboardreportsCallback(resultobject){
	if(resultobject.Daywiserequestdata.length===0 && resultobject.tablewiserequestData.length==0){
		...
		for(var i=0;i<resultobject.Daywiserequestdata.length;i++){
			...
			daywiserequestdata_service[i]=resultobject.Daywiserequestdata[i].nurse;
			daywiserequestdata_water[i]=resultobject.Daywiserequestdata[i].sos;
			daywiserequestdata_like[i]=resultobject.Daywiserequestdata[i].clean;				
			}
	...
	tablewiserequest_like=new Array();
		...
		for(var i=0;i<tablewiserequest_tableno.length;i++){
	        ...
	        alltabledata_donutblackreports(tablewiserequest_tableno[i],tablewiserequest_service[i],tablewiserequest_drink[i],tablewiserequest_bill[i]);
	       /* }*/
	    }
	}
...
function alltabledata_donutblackreports(DivID,serviceCount,drinkCount,billCount){
	$('#'+DivID).highcharts({
        chart: {
            type: 'pie',
            options3d: {
